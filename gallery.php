...
<head>
    ...
    <title>Gallery - <?php echo $t['title']; ?></title>
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="dropdown">
                    <button class="btn btn-light btn-sm border-0 shadow-sm dropdown-toggle" data-bs-toggle="dropdown">
                        <i class="bi bi-translate me-1"></i> <?php echo strtoupper($lang); ?>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end border-0 shadow-lg p-2">
                        <li><a class="dropdown-item small rounded-2" href="?lang=en">English</a></li>
                        <li><a class="dropdown-item small rounded-2" href="?lang=mr">मराठी</a></li>
                    </ul>
                </div>
        ...
        <div class="container">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-4">
                <div class="text-center text-md-start">
                    ...
                    <div class="small text-muted">&copy; <?php echo date("Y"); ?> All Rights Reserved.</div>
                </div>
            ...
            <div class="text-center small text-muted opacity-50">
                Designed with Devotion & Ant Design Principles
            </div>
        </div>
    </footer>
