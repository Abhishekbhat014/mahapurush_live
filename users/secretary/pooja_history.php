...
<head>
    ...
    <title>Pooja History - <?= $t['title'] ?? 'Temple' ?></title>
        ...
        <div class="row">
            ...
            <main class="col-lg-10 p-0">
                <div class="dashboard-hero">
                    <h2 class="fw-bold mb-1">Pooja History</h2>
                    <p class="text-secondary mb-0">Content coming soon.</p>
                </div>
                <div class="px-4 pb-5">
                    <div class="ant-card p-4">
                        <div class="text-muted">This page will be updated with role-specific functionality.</div>
                    </div>
                </div>
            </main>
        </div>
