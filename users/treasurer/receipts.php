...
if ($con) {
    ...
    if (!empty($search)) {
        ...
        $query .= " AND (r.receipt_no LIKE '$searchTerm' OR u.first_name LIKE '$searchTerm' OR u.phone LIKE '$searchTerm')";
    }
                                    ...
                                    <?php if (!empty($receipts)): ?>
                                        <?php foreach ($receipts as $r):
                                            ...
                                            if (strpos($mode, 'cheque') !== false)
                                                $badge = 'badge-cheque';
                                            ?>
                                            <tr style="cursor: pointer;" onclick="window.open('../receipt/view.php?no=<?= $r['receipt_no'] ?>', '_blank')">
