...
$currentPage = 'event_approvals.php';
...
if (isset($_GET['action'], $_GET['id'])) {
    ...
    header("Location: event_approvals.php?msg=success");
    exit;
}
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($events)): ?>
                                            <tr>
                                                <td class="fw-bold text-dark">
                                                    <?= htmlspecialchars($row['name'] ?? $row['title']) ?>
                                                </td>
                                                <td>
                                                    <div class="fw-medium">
                                                        <?= date('d M Y', strtotime($row['conduct_on'] ?? $row['event_date'])) ?>
                                                    </div>
                                                </td>
