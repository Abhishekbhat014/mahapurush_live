...
<head>
    ...
    <title><?php echo $t['settings'] ?? 'Settings'; ?> - <?= $t['title'] ?></title>
        ...
        <div class="row">
            ...
            <main class="col-lg-10 p-0">
                <div class="dashboard-hero">
                    <h2 class="fw-bold mb-1"><?php echo $t['settings'] ?? 'Settings'; ?></h2>
                    <p class="text-secondary mb-0"><?php echo $t['settings_subtitle'] ?? 'Portal preferences and defaults.'; ?></p>
                </div>
                ...
                <div class="px-4 pb-5">
                    <div class="ant-card">
                        <div class="p-4">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label class="form-label"><?php echo $t['notification_email'] ?? 'Notification Email'; ?></label>
                                    <input type="email" class="form-control" disabled placeholder="chairman@example.com">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label"><?php echo $t['default_approver'] ?? 'Default Approver'; ?></label>
                                    <input type="text" class="form-control" disabled placeholder="Chairman">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label"><?php echo $t['approval_mode'] ?? 'Approval Mode'; ?></label>
                                    <select class="form-select" disabled>
                                        <option selected><?php echo $t['manual'] ?? 'Manual'; ?></option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label"><?php echo $t['auto_assign'] ?? 'Auto Assign'; ?></label>
                                    <select class="form-select" disabled>
                                        <option selected><?php echo $t['disabled'] ?? 'Disabled'; ?></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                <button class="btn btn-primary rounded-pill px-4" disabled>
                                    <i class="bi bi-save me-1"></i> <?php echo $t['save_changes'] ?? 'Save Changes'; ?>
                                </button>
                            </div>
                        </div>
                    </div>
